...
<form class="form-horizontal" role="form" method="post" action="index.php?action=register">
  ...
  <div class="form-group">
    <label for="inputPassword1" class="col-lg-2 control-label">*Confirmar</label>
    <div class="col-lg-10">
      <input type="password" required name="confirm" class="form-control" id="inputPassword1" placeholder="Confirmar">
    </div>
  </div>
  <div class="form-group">
