...
<html lang="en">
  <head>
    ...
    <title>.: Administrador Sistema v1.6 :.</title>
...
<script src="res/morris/morris.js"></script>
  ...
  <link rel="stylesheet" href="res/morris/example.css">
          <script src="res/jspdf/jspdf.min.js"></script>
          <script src="res/jspdf/jspdf.plugin.autotable.js"></script>
  </head>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./"> TIENDA PRO <sup><small><span class="label label-primary">v3.8</span></small></sup> </a>
        </div>
